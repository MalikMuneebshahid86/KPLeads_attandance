...
# Rest of the
#
ALLOWED_IP_ADDRESSES = ["124.109.36.140"]
def get_user_ip():
...
def main():
    favicon_path = "/Users/apple/PycharmProjects/KPleads_attandance_management/KP favicon (1).png"  # Replace with the filename of your custom favicon
    ...
    logo_image = "/Users/apple/PycharmProjects/CRM_KPLEADS/django_venv/KP favicon (1).png"
    # Authentication
